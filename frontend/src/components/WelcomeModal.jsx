...
const features = [
  { icon: Activity,   color: CATEGORY_COLORS.Normal, label: 'Live Traffic Monitoring',   desc: 'Real-time network flow analysis across 125K+ connections' },
  { icon: ShieldCheck,color: CATEGORY_COLORS.Probe,  label: 'Multi-class Detection',      desc: 'Classifies DoS, Probe, R2L, U2R and Normal traffic' },
  { icon: Brain,      color: '#3b82f6',               label: 'XGBoost ML Model',           desc: '98.4% confidence on NSL-KDD dataset with 41 features' },
  { icon: Terminal,   color: CATEGORY_COLORS.R2L,    label: 'Live Threat Feed',            desc: 'Terminal-style stream of detected intrusion events' },
]
        ...
        >
          ...
          <div style={{ padding: '32px 36px 28px' }}>
            ...
            >
              ...
              <span style={{ color: '#888' }}>NSL-KDD</span> and{' '}
              <span style={{ color: '#888' }}>CICIDS2017</span> datasets using XGBoost
            ...
            >
              <span style={{ fontSize: 11, color: '#555' }}>
                💡 Press{' '}
                <kbd style={{
                  fontSize: 10, color: '#888', background: '#1a2332',
            ...
            >
              <motion.button
                whileHover={{ background: '#1d4ed8', gap: 10 }}
                whileTap={{ scale: 0.98 }}
                onClick={onClose}
                style={{
                  width: '100%',
